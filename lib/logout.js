  ...
  return function (req, res, next) {
    try {
      ...
      if (req.query.SAMLRequest || req.body.SAMLRequest) {
        return parseIncomingLogoutRequest(req.query.SAMLRequest || req.body.SAMLRequest, function (err, requestData) {
          if (err) { return next(err); }
      ...
      if (req.query.SAMLResponse || req.body.SAMLResponse) {
        ...
        validateSamlResponse(req, res, function(err){
          ...
          // TODO remove session from incoming LogoutResponse
          var sessionIndex = ''; //TODO
