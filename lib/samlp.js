...
module.exports.auth = function(options) {
  ...
  return function (req, res, next) {
    ...
    utils.parseSamlRequest((req.query || {}).SAMLRequest || (req.body || {}).SAMLRequest, opts, function(err, samlRequestDom) {
      if (err) return next(err);
...
module.exports.parseRequest = function(req, options, callback) {
  ...
  utils.parseSamlRequest(samlRequest, options, function(err, samlRequestDom) {
    if (err) {
      return callback(err);
    }
