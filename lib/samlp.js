var saml20 = require('@techteamer/saml').Saml20;
...
function getSamlResponse(samlConfig, user, callback) {
  ...
  createAssertion.call(saml20, {
    ...
    SPNameQualifier: ni.SPNameQualifier || options.SPNameQualifier,
...
module.exports.buildSamlResponse = buildSamlResponse;

module.exports.getSamlErrorResponse = function (options) {
