...
module.exports = function(options) {
  ...
  return function (req, res) {
    getSamlRequest(req.query.SAMLRequest, function(err, samlRequestDom) {
      var audience = xpath.select("//*[local-name(.)='Issuer' and namespace-uri(.)='urn:oasis:names:tc:SAML:2.0:assertion']/text()", samlRequestDom);
