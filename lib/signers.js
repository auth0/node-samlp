  ...
  sig.keyInfoProvider = {
    ...
    getKey: function (keyInfo) {
      ...
      if(!keyInfo || keyInfo.length===0){
        if(!options.signingCert) throw new Error('options.cert must be specified for SAMLResponses with no embedded signing certificate');
...
module.exports.isValidContentAndSignature = function (content, signature, options) {
  ...
  return verifier.verify(options.signingCert, signature, 'base64');
};
