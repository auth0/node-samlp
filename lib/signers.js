...
function ECDSASHA384 () {
  ...
  */
  this.verifySignature = function(str, key, signatureValue, callback) {
    const hasher = crypto.createVerify("sha384");
...
SignedXml.SignatureAlgorithms["http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha384"] = ECDSASHA384;
SignedXml.HashAlgorithms['http://www.w3.org/2001/04/xmlenc#sha384'] = SHA384;
